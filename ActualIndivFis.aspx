<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="ActualIndivFis.aspx.vb"
    Inherits="INTeatroDig.ActualIndivFis" Culture="es-AR" MaintainScrollPositionOnPostBack="True"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    <div class="row">
      ...
      <div class="col-md-8 col-centered page-institucional" style="text-align: center">
           <h2>Actualización de Datos Individual de Personas Humanas</h2>
      </div>
   ...
   <div class="row">
      ...
      <div class="col-md-10 col-centered Texto1" style="text-align: center">
           ...
           <asp:CheckBox ID="AceptoDJ" runat="server" Text="Acepto" AutoPostBack="True" />
   ...
   <div id="tablaDatos" runat="server" visible="false" class="container-fluid">
    ...
    <div class="row">
       ...
       <div class="col-md-7 col-centered" style="text-align: left">
           <asp:Label ID="LabelSoli" runat="server" Text="Solicitud" Width="164px" CssClass="Texto"></asp:Label>
       </div>
       <div class="col-md-1 text-right">
       </div>
    </div>
    ...
    <div class="row">
       ...
       <div class="col-md-4 col-centered" style="text-align: left">
             ...
             <asp:Label ID="lblErrorFechaNacimiento" runat="server" CssClass="text-danger"></asp:Label>
       </div>
    ...
    <div class="row">
       ...
       <div class="col-md-4 col-center">
           ...
           <asp:Label ID="lblErrorCheckBoxEdad" runat="server" CssClass="text-danger"></asp:Label>
       </div>
    ...
    <div class="row">
       ...
       <div class="col-md-4 col-centered" style="text-align: left">
           ...
           <asp:Label ID="lblErrorddlSexo" runat="server" CssClass="text-danger"></asp:Label>
    ...
    <div class="row">
       ...
       <div class="col-md-2 col-centered" style="text-align: left">
           ...
           <asp:Label ID="lblErrorDdlNacional" runat="server" CssClass="text-danger"></asp:Label>
       </div>
     ...
     <div class="row">
       ...
       <div class="col-md-7 col-centered" style="text-align: left">
           ...
           <asp:Label ID="lblErrorTextBoxresid" runat="server" CssClass="text-danger"></asp:Label>
       </div>
       <div class="col-md-1 text-right">
       </div>
     </div>
     ...
     <div class="row">
       ...
       <div class="col-md-1 col-centered" style="text-align: left">
           ...
           <asp:Label ID="lblErrorCPOSTAL" runat="server" CssClass="text-danger"></asp:Label>
       </div>
     ...
     <div class="row">
        ...
        <div class="col-md-4 col-centered" style="text-align: left">
            ...
            <asp:Label ID="lblErrorTextBoxDompar" runat="server" CssClass="text-danger"></asp:Label>
        </div>
        <div class="col-md-3 col-left">
     ...
     <div class="row">
        ...
        <div class="col-md-4 col-centered" style="text-align: left">
            ...
            <asp:Label ID="LabelErrorFormacion" runat="server" CssClass="text-danger"></asp:Label>
        </div>
        <div class="col-md-3 col-left">
     ...
     <div class="row">
        ...
        <div class="col-md-4 col-centered" style="text-align: left">
            ...
            <asp:Label ID="LabelErrorTitulo" runat="server" CssClass="text-danger"></asp:Label>
        </div>
        <div class="col-md-3 col-left">
     ...
     <div class="row">
       ...
       <div class="row">
          ...
          <div class="col-md-7 col-centered" style="text-align: left">
             <asp:Label ID="txtErrorDisciplina" runat="server" CssClass="text-danger"></asp:Label>
          </div>
          <div class="col-md-1 text-right">
          </div>
       </div>
       ...
       <div class="row">
          ...
          <div class="col-md-10 col-centered" style="text-align: center;">
             ...
             <asp:Label ID="lblErrorCheckBox1" runat="server" CssClass="text-danger"></asp:Label>
          </div>
          <div class="col-md-1 text-right">
          </div>
       </div>
       ...
       <div class="row">
          ...
          <div class="col-md-10 col-centered" style="text-align: center">
              <asp:Button ID="BtnEnviar" runat="server" Text="Confirmar Actualización de Datos" CssClass="btn btn-success" /> 
              <asp:Button ID="btnCancelar" runat="server" class="btn btn-warning" Text="Cancelar" /> &nbsp;&nbsp;<asp:Label ID="Label9" runat="server" style="color: red" Text="[*]"></asp:Label>   
          </div>
          <div class="col-md-1 text-right">
          </div>
       </div>
        ...
        $(document).ready(function () {
            ...
            $("#aspnetForm").validate({
                rules: {
                    ...
                    <%=TextBoxCopost.UniqueID %>:{
                        required: "<span  style='color:red'>* campo requerido *</span>",
                        range:  "<span  style='color:red'>* Debe ingresar entre 1000 y 9000 *</span>"
                    },
                    <%=TextBoxDompar.UniqueID %>:{
                        required: "<span  style='color:red'>* campo requerido *</span>"
                    },
