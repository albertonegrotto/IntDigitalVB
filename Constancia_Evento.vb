...
Public Class Constancia_Evento
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "INTeatroDig.Constancia_Evento.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedConstancia_Evento
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Constancia_Evento = New Constancia_Evento
        rpt.Site = Me.Site
        Return rpt
    End Function
