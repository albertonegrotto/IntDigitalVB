<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="registroEspectaculo.aspx.vb" Inherits="INTeatroDig.registroEspectaculo"
    Title="Registro de Espectáculos Concertados" Culture="es-AR" MaintainScrollPositionOnPostBack="True" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
   <div class="row">
      ...
      <div class="col-md-8 col-centered page-institucional" style="text-align: center">
           <h2>Registro de Espectáculos Concertados</h2>
      </div>
   ...
   <div id="tablaDatos" runat="server" visible="false" class="container-fluid">
       ...
       <div class="row">
          ...
          <div class="col-md-4 col-centered" style="text-align: left">
              <asp:TextBox ID="txtDenominacion" runat="server" MaxLength="200" Columns="40" CssClass="form-control"
                  ToolTip="Ingrese la Denominación del Escpectáculo" onkeypress="return validate(event)"></asp:TextBox>
          </div>
          <div class="col-md-2 col-left">
       ...
       <div class="row">
          ...
          <div class="col-md-3 col-centered" style="text-align: left">
              <asp:TextBox ID="txtAutor" runat="server" MaxLength="100" Columns="40" CssClass="form-control"
                  ToolTip="Ingrese el nombre del autor"></asp:TextBox>
          </div>
          <div class="col-md-4 col-left">
       ...
       <div class="row">
          ...
          <div class="col-md-9 col-center">
              <asp:label ID="Label3" runat="server" CssClass="TextoComentario">(Ingrese el CUIL / CUIT de cada integrante y pulse el botón &quot;Agregar Integrante&quot;)</asp:label>
          </div>
          <div class="col-md-1 col-left">
          </div>
       </div>
          ...
          <div class="col-md-9 col-centered" style="text-align: center; font-family:'Trebuchet MS'; font-size:small">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AllowSorting="True"
                        ...
                        <Columns>
                            ...
                            <asp:CommandField
                                ...
                                EditImageUrl="images/btnEdit.gif" EditText="Edit" UpdateImageUrl="images/btnUpdate.gif" UpdateText="Update"
                                CancelText="Cancel" CancelImageUrl="images/btnCancel.gif" ControlStyle-Font-Bold="True">
                    ...
                    <asp:SqlDataSource ConnectionString="<%$ ConnectionStrings:INTeatroDig %>" ID="SqlDataSource1" runat="server"
                        SelectCommand="SELECT I.idIntegrante AS idIntegrante,I.cuit AS cuit,I.codigoRegistro AS codigoRegistro,I.CUIL AS CUIL,
                                        ...
                                        FROM IntegrantesTemp I, RegisDig R
                                        WHERE I.cuil = R.cuil AND I.cuit = @cuit ORDER BY I.CUIL"
       ...
       <div class="row">
          ...
          <div class="col-md-10 col-centered" style="text-align: center">
             ...
             <br />
             <asp:CheckBox ID="chkAcepto" runat="server" Text="Acepto" /> &nbsp;&nbsp;<asp:Label ID="Label10" runat="server" style="color: red" Text="[*]"></asp:Label>            
          </div>
          <div class="col-md-1 text-right">
          </div>
       </div>
