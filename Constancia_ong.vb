...
Public Class Constancia_ong
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "INTeatroDig.Constancia_ong.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedConstancia_ong
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Constancia_ong = New Constancia_ong
        rpt.Site = Me.Site
        Return rpt
    End Function
