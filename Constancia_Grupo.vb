...
Public Class Constancia_Grupo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "INTeatroDig.Constancia_Grupo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedConstancia_Grupo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Constancia_Grupo = New Constancia_Grupo
        rpt.Site = Me.Site
        Return rpt
    End Function
