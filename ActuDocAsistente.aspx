<%@ Page Title="Actualiza Adjuntos Asistente Técnico" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="ActuDocAsistente.aspx.vb" 
    Inherits="INTeatroDig.ActuDocAsistente" MaintainScrollPositionOnPostBack="True" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
       <div class="row">
           ...
           <div class="col-md-8 col-centered page-institucional" style="text-align: center">
               <h2>Actualización Documentación Asistente Técnico</h2>
           </div>
       ...
       <div class="row" id="Foto" runat="server">
          ...
          <div class="col-md-2 col-left">
             <asp:Label ID="LabelNombreUploadf" runat="server" CssClass="form-control" Height="75px"></asp:Label>
          </div>
          <div class="col-md-2 col-left">
