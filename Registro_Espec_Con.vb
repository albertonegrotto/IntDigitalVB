...
Public Class Registro_Espec_Con
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "INTeatroDig.Registro_Espec_Con.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRegistro_Espec_Con
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Registro_Espec_Con = New Registro_Espec_Con
        rpt.Site = Me.Site
        Return rpt
    End Function
