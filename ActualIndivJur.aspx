<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="ActualIndivJur.aspx.vb" Inherits="INTeatroDig.ActualIndivJur"
    title="Actualización de Personas Jurídicas"  Culture="es-AR" MaintainScrollPositionOnPostBack="True"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
   <div class="row">
      ...
      <div class="col-md-8 col-centered page-institucional" style="text-align: center">
           <h2>Actualización de Datos Individual de Personas Jurídicas</h2>
      </div>
...
<div id="tablaDatos" runat="server" visible="false" class="container-fluid">
    ...
    <div class="row">
       ...
       <div class="col-md-8 col-center">
           <asp:label ID="Label1" runat="server" CssClass="observacion">Consignar la denominación completa y exacta de la Entidad, sin abreviaturas ni comillas ni caracteres especiales.</asp:label>
       </div>
       <div class="col-md-2 col-left">
       </div>
    </div>
