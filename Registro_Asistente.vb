...
Public Class Registro_Asistente
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "INTeatroDig.Registro_Asistente.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRegistro_Asistente
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Registro_Asistente = New Registro_Asistente
        rpt.Site = Me.Site
        Return rpt
    End Function
