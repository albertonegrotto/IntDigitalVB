...
Public Class Registro_Grupo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "INTeatroDig.Registro_Grupo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRegistro_Grupo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Registro_Grupo = New Registro_Grupo
        rpt.Site = Me.Site
        Return rpt
    End Function
