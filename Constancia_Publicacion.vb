...
Public Class Constancia_Publicacion
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Constancia_Publicacion.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "INTeatroDig.Constancia_Publicacion.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_wregistro() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedConstancia_Publicacion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Constancia_Publicacion = New Constancia_Publicacion
        rpt.Site = Me.Site
        Return rpt
    End Function
