<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="menu.aspx.vb" Inherits="INTeatroDig.menu" %>
    ...
    <div id="marco">
		...
		<div id='cssmenu'>
			<ul>
				...
				<li><a href="#"><img src="images/desvincular.png" alt=""><span class="spanli">Desvinculación de Registro</span></a></li>
