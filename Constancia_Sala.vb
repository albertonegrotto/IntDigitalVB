...
Public Class Constancia_Sala
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "INTeatroDig.Constancia_Sala.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedConstancia_Sala
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Constancia_Sala = New Constancia_Sala
        rpt.Site = Me.Site
        Return rpt
    End Function
