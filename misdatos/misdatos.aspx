                    ...
                    <div class="collapse navbar-collapse" id="header-navbar">
                        ...
                        <div class="row clearfix">
                            <ul class="nav navbar-nav navbar-menu">
                                <li><a href='index.aspx' class="menu-dsk menu-inicio"><span>INICIO</span></a></li>
                                <li><a href='preguntasFrecuentes.aspx' class="menu-dsk menu-inicio"><span>PREGUNTAS FRECUENTES</span></a></li>
                                <li><a href='contacto.aspx' class="menu-dsk menu-inicio"><span>FORMULARIO DE CONTACTO</span></a></li>
                                <li><a href='http://inteatro.gob.ar' target="_blank" class="menu-dsk menu-inicio"><span>WEB INT</span></a></li>
                                <li><a href='logout.aspx' class="menu-dsk  menu-inicio" runat="server" id="CerrarSesion"><span>CERRAR SESIÓN</span></a></li> 
                            </ul>
                        </div>
                    </div><!-- /.navbar-collapse -->
                </div><!-- /.container-fluid -->
